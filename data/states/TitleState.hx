...
import openfl.filters.ShaderFilter;
	...
	var sheddar:CustomShader  = new CustomShader("glitchShader");
...
override function create() {
	...
	var modes:Map<String, Array<Bool>> = [
		//"BOLD:" => [true, false],"BOLD:ITALIC" => [true, true],
	...
	{
		onEndIntro();
		openSubState(new ModSubState("MainMenuSubState"));
		add(logo);
	}
}
...
override function update(elapsed:Float){
	...
	sheddar.data.iTime.value = [(Math.cos(elapsed)/9999)+1];
...
override public function fucker() {
